...
shp_dir = os.path.expanduser('~/Data/Arctic/alaska/northern_alaska_extent')
alaska_shp_dir = os.path.expanduser('~/Data/Arctic/alaska/NoAK_LandscapePermafrost_GIS_files/NoAK_LandscapePermafrost_GIS_11242014/NoAK_LandscapePermafrost_11242014shp')

def main():

    # grid polygons
    qtp_grid_50km = os.path.join(shp_dir,'northern_alaska_grid_50km_v2.shp')

    # main permaforst areas based on permafrost map, has been pre-processed: remove small ones, simply the boundaries
    qtp_main_perma_area_simp = os.path.join(alaska_shp_dir,'NoAK_LandscapePermafrost_11242014_edit_buff100.shp')
